...
// use holons::persistence_layer::holon_node::delete_holon_node;
// use holons::shared_objects_layer::{CommitResponse, HolonError, HolonState};
// use holons_guest::guest_persistence::commit_service::CommitService;
// use holons_guest::guest_persistence::holon_service;
// use holons_guest::guest_persistence::local_holon_resolver::LocalHolonResolver;
