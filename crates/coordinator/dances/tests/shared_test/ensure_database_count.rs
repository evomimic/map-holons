...
pub async fn execute_ensure_database_count(conductor: &SweetConductor, cell: &SweetCell, expected_count: MapInteger)->() {
    ...
    let request = build_get_all_holons_dance_request();
