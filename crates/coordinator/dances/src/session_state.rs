...
pub struct SessionState {
    ...
    local_holon_space: Option<HolonSpaceId>,
}
...
impl SessionState {
    ...
    pub fn get_local_holon_space(&self) -> Option<HolonSpaceId> {
    ...
    pub fn init_context_from_state(&self)-> HolonsContext {
        ...
        let local_holon_space = self.get_local_holon_space_reference();
    ...
    pub fn set_local_holon_space(&mut self, local_holon_space: Option<HolonSpaceId>) {
