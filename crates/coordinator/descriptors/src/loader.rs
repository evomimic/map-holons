...
pub fn load_core_schema(context: &HolonsContext) -> Result<StagedReference, HolonError> {
        ...
        let schema_ref = context.commit_manager.borrow_mut().stage_holon(schema.0);
    /*
        ...
        let type_descriptor_ref = context.commit_manager.borrow_mut().stage_holon(type_descriptor.0);
        ...
        let _meta_holon_descriptor_index = context.commit_manager.borrow_mut().stage_holon(meta_holon_descriptor.0);
        ...
        let _meta_relationship_descriptor_index = context.commit_manager.borrow_mut().stage_holon(meta_relationship_descriptor.0);
        ...
        let _meta_property_descriptor_index = context.commit_manager.borrow_mut().stage_holon(meta_property_descriptor.0);
