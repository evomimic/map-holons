...
use crate::{
    ...
    reference_layer::{
        HolonReference, HolonsContextBehavior, ReadableHolon, TransientReference,
...
impl WriteableHolonReferenceLayer for SmartReference {
...
impl WriteableHolon for SmartReference {
