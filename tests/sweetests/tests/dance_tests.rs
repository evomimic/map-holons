...
// use execution_steps::load_core_schema::execute_load_new_schema;
...
// #[case::simple_stage_new_from_clone_test(stage_new_from_clone_fixture())]
    ...
    for step in test_case.steps {
        ...
        match step {
            ...
            DanceTestStep::MatchSavedContent { expected_status } => {
                execute_match_db_content(test_context.as_ref(), &mut test_state, expected_status)
                    .await
            }
            ...
            DanceTestStep::StageNewVersion { source, expected_status } => {
                ...
                execute_stage_new_version(test_context.as_ref(), &mut test_state, source, expected_status)
                    .await
            }
