...
impl DancesTestCase {
    ...
    pub fn add_commit_step(
        ...
        self.steps.push(DanceTestStep::Commit { holon, expected_status });
        Ok(())
    }

    pub fn add_database_print_step(
        &mut self,
    ) -> Result<(), HolonError> {
    ...
    pub fn add_delete_holon_step(
        ...
        self.steps.push(DanceTestStep::DeleteHolon { holon, expected_status });
        Ok(())
    }
    ...
    pub fn add_remove_properties_step(
        ...
        self.steps.push(DanceTestStep::RemoveProperties { holon, properties, expected_status });
        Ok(())
    }
    ...
    pub fn add_stage_holon_step(
        ...
        self.steps.push(DanceTestStep::StageHolon { holon, expected_status });
        Ok(())
    }
    ...
    pub fn add_stage_new_from_clone_step(
        ...
        self.steps.push(DanceTestStep::StageNewFromClone { source, new_key, expected_status });
        Ok(())
    }
    ...
    pub fn add_stage_new_version_step(
        ...
        self.steps.push(DanceTestStep::StageNewVersion { source, expected_status });
        Ok(())
    }
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            DanceTestStep::AddRelatedHolons {
                ...
                write!(f, "AddRelatedHolons to Holon {:#?} for relationship: {:#?}, added_count: {:#?}, expecting: {:#?}, holon: {:?}", source, relationship_name, holons.len(), expected_status, expected_holon)
            }
            DanceTestStep::Commit { holon, expected_status } => {
                write!(f, "Commit({:?}, expecting: {:?},)", holon, expected_status)
            }
            DanceTestStep::DeleteHolon { holon, expected_status } => {
                write!(f, "DeleteHolon({:?}, expecting: {:?},)", holon, expected_status)
            }
            ...
            DanceTestStep::RemoveProperties { holon, properties, expected_status } => {
                write!(
                    ...
                    properties, holon, expected_status,
                )
            }
            DanceTestStep::RemoveRelatedHolons {
                ...
                write!(f, "RemoveRelatedHolons from Holon {:#?} for relationship: {:#?}, added_count: {:#?}, expecting: {:#?}", source, relationship_name, holons.len(), expected_status)
            }
            DanceTestStep::StageHolon { holon , expected_status} => {
                write!(f, "StageHolon({:?}, expecting: {:?},)", holon, expected_status)
            }
