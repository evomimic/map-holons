...
use crate::shared_objects_layer::implementation::space_manager::HolonSpaceManager;
...
impl HolonsContext {
    ...
    pub fn init_context_from_session(
        ...
        let context = HolonsContext::new(space_manager.clone());
...
impl HolonsContextBehavior for HolonsContext {
