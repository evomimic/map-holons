...
use crate::persistence_layer::delete_holon_node;
use crate::reference_layer::staged_reference::StagedIndex;
use crate::reference_layer::{
    HolonReference, HolonSpaceBehavior, HolonStagingBehavior, HolonsContextBehavior,
    StagedReference, StateMobility,
};
use crate::shared_objects_layer::cache_access::HolonCacheAccess;
use crate::shared_objects_layer::implementation::commit_service::CommitService;
use crate::shared_objects_layer::implementation::holon_cache_manager::HolonCacheManager;
use crate::shared_objects_layer::implementation::holon_service;
use crate::shared_objects_layer::implementation::local_holon_resolver::LocalHolonResolver;
use crate::shared_objects_layer::implementation::nursery::Nursery;
use crate::shared_objects_layer::nursery_access::NurseryAccess;
use crate::shared_objects_layer::Holon;
use crate::shared_objects_layer::{CommitResponse, HolonError, HolonState};
...
impl NurseryAccess for HolonSpaceManager {
...
impl HolonCacheAccess for HolonSpaceManager {
    ...
    fn get_rc_holon(&self, holon_id: &HolonId) -> Result<Rc<RefCell<Holon>>, HolonError> {
        match holon_id {
            HolonId::Local(local_id) => {
                ...
                self.local_cache_manager.get_local_holon(local_id)
            }
            HolonId::External(_) => {
...
impl StateMobility for HolonSpaceManager {
