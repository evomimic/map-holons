...
use crate::persistence_layer::{
    create_holon_node, delete_holon_node, get_all_holon_nodes, update_holon_node,
    UpdateHolonNodeInput,
};
use crate::reference_layer::{HolonReference, HolonsContextBehavior};
use crate::shared_objects_layer::implementation::smartlink::{
    get_all_relationship_links, get_relationship_links,
};
use crate::shared_objects_layer::{HolonCollection, HolonError, RelationshipMap, RelationshipName};
...
//     }
//
//     fn get_key(&self, _context: &dyn HolonsContextBehavior) -> Result<Option<MapString>, HolonError> {
//         self.is_accessible(AccessType::Read)?;
//         let key = self
//             .property_map
