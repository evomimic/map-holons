//! Canonical schema intermediate representation for MAP Schema tooling.
//!
...
use crate::schema_index::{SymbolId, SymbolIndex};
...
pub struct Schema {
    ...
    pub literal_properties: serde_json::Map<String, Value>,
